...
Before we talk about Loops, we need to understand a **Array**.
...
[Image of C++ for loop vs while loop flowchart]
...
#### **4. The Trap: "The Infinite Loop"**

A loop must always have an exit condition.

  * **The Bug:** If you write `while(true)` or a condition that never becomes `false`, the program gets stuck there forever. The robot freezes, stops reading sensors, and stops listening to safety commands.
...
4.  **Verification:** The sum is `175.8`. The average should be `35.16`.
